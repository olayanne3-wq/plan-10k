...
(function () {
  ...
  async function monterEcranAuth(conteneurId) {
    ...
    hote.innerHTML =
      '<style>' +
      '#ecran-auth { position: fixed; inset: 0; z-index: 9999; background: #07162F; color: #f1f5f9; display: flex; align-items: center; justify-content: center; padding: 20px; box-sizing: border-box; }' +
      ...
      '#ecran-auth .btn-principal { width: 100%; padding: 12px; border-radius: 8px; border: none; background: #1E4ED8; color: #07162F; font-weight: 700; font-size: 0.95rem; cursor: pointer; margin-top: 4px; }' +

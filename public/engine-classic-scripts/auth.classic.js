...
(function () {
  ...
  async function monterEcranAuth(conteneurId) {
    ...
    hote.innerHTML =
      ...
      '#ecran-auth .onglets { display: flex; border: 1px solid #D6DCE5; border-radius: 10px; overflow: hidden; margin-bottom: 20px; }' +
      '#ecran-auth .onglet { flex: 1; padding: 10px; text-align: center; background: #FFFFFF; color: #1F2937; cursor: pointer; font-size: 0.85rem; border: none; transition: background 0.15s; }' +
      ...
      '#ecran-auth input { width: 100%; padding: 11px 12px; margin-bottom: 14px; border-radius: 8px; border: 1px solid #D6DCE5; background: #FFFFFF; color: #1F2937; font-size: 0.95rem; box-sizing: border-box; }' +

...
(function () {
  ...
  async function monterEcranAuth(conteneurId) {
    ...
    hote.innerHTML =
      '<style>' +
      '#ecran-auth { position: fixed; inset: 0; z-index: 9999; background: #F8FAFC; color: #1F2937; display: flex; align-items: center; justify-content: center; padding: 20px; box-sizing: border-box; }' +
      ...
      '#ecran-auth .bandeau .sous-titre { color: #1E4ED8; font-size: 0.75rem; letter-spacing: 0.08em; text-transform: uppercase; margin-top: 4px; }' +
      '#ecran-auth .onglets { display: flex; border: 1px solid #1F293722; border-radius: 10px; overflow: hidden; margin-bottom: 20px; }' +
      '#ecran-auth .onglet { flex: 1; padding: 10px; text-align: center; background: #F8FAFC; color: #1F2937; cursor: pointer; font-size: 0.85rem; border: none; transition: background 0.15s; }' +
      ...
      '#ecran-auth input { width: 100%; padding: 11px 12px; margin-bottom: 14px; border-radius: 8px; border: 1px solid #1F293722; background: #F8FAFC; color: #1F2937; font-size: 0.95rem; box-sizing: border-box; }' +
      '#ecran-auth input:focus { outline: none; border-color: #1E4ED8; }' +
      '#ecran-auth .btn-principal { width: 100%; padding: 12px; border-radius: 8px; border: none; background: #1E4ED8; color: #F8FAFC; font-weight: 700; font-size: 0.95rem; cursor: pointer; margin-top: 4px; }' +
